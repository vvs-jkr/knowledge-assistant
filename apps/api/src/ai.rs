...
\n\nЕсли пользователь просит сгенерировать тренировку -- отвечай СТРОГО в формате примеров из раздела 'Примеры тренировок по типам'. Никаких отступлений.\
...
\n### Разминка (5 минут) / Круг 1 / Отдых 30 сек / Заминка / Не забывай пить воду\
\n---\
\nПравила:\
\n- Только WOD: название, формат (AMRAP X мин / For Time / EMOM / раунды), упражнения\
\n- Тип выбирай по запросу и примерам из истории\
